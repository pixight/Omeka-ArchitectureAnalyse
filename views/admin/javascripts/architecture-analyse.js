...
(function ($) {
     ...
     */
    Omeka.ArchitectureAnalyse.enableSorting = function () {
        $('.sortable').sortable({
            items: 'li.element',
     ...
     */
    Omeka.ArchitectureAnalyse.addHideButtons = function () {
     ...
     */
    Omeka.ArchitectureAnalyse.manageItemTypes = function (addNewRequestUrl, addExistingRequestUrl, changeExistingElementUrl) {
        /**
        ...
        function toggleElements(button) {
            var elementsToRemove = $('#architectureanalyse_remove');
        ...
        $('#add-element').click( function (event) {
            event.preventDefault();
            var elementCount = $('#architecture-analyse-elements li').length;
            var typeValue = "new";
            var requestUrl;
            if (typeValue === 'new') {
